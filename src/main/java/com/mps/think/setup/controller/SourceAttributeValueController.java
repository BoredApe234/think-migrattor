...
public class SourceAttributeValueController {
	...
	@Autowired
	SourceAttributeValueService sourceAttributeValueServiceImpl;
	...
	@DeleteMapping("/deleteSourceAttributeValue/{id}")
	public ResponseEntity<?> deleteSourceAttributeValue(@PathVariable("id") Integer id) throws Exception {
		return ResponseEntity.ok(sourceAttributeValueServiceImpl.deleteSourceAttributeValue(id));
	}

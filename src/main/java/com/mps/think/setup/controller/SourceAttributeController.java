...
public class SourceAttributeController {
	@Autowired
	SourceAttributeService sourceAttributeServiceImpl;
	...
	public ResponseEntity<?> deleteSourceAttribute(@PathVariable("id") Integer id) throws Exception {
		return ResponseEntity.ok(sourceAttributeServiceImpl.deleteSourceAttributeById(id));
	}
